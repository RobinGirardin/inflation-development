...
Compared to the initial analysis done for cleaning purpose, nothinng much really change. `broad_money_pct` is still the best recorded predictor of inflation_rate with a negative association of -0.34. 

Naturally, this doesn't account for potential covariates and non-linear relationships, which for example broad money (%) and inflation have (See [Broad Money - Inflation (%)](#broad-money-(---inflation))).
...
Sadly, there is no major relationship recorded with the inflation rate.
